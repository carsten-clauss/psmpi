...
void MPIDI_PSP_RecvCtrl(int tag, int context_id, int src_rank, pscom_connection_t * con,
                        enum MPID_PSP_MSGTYPE msgtype);
...
static inline int MPIDI_PSP_env_get_int(const char *env_name, int _default)
{
