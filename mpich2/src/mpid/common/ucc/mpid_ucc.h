...
/* This priority level could be overwritten by the device? */
...
typedef struct {
    ...
    ucc_thread_mode_t thread_mode;      /* enumeration representing the thread model to be supported by the UCC library */
